...
function MessageBubble(_a) {
    ...
    return (jsxs("div", { style: styles.container, children: [jsx("div", { style: styles.avatar, children: isBot ? (jsx(Bot, { style: { width: '20px', height: '20px', color: '#8b8b8b' } })) : (jsx(User, { style: { width: '20px', height: '20px', color: '#4a90e2' } })) }), jsx("div", { style: styles.bubble, children: isTyping ? (jsxs("div", { style: styles.typingDots, children: [jsx("div", { style: __assign(__assign({}, styles.dot), { animationDelay: '0s' }) }), jsx("div", { style: __assign(__assign({}, styles.dot), { animationDelay: '0.3s' }) }), jsx("div", { style: __assign(__assign({}, styles.dot), { animationDelay: '0.6s' }) })] })) : (jsxs(Fragment, { children: [jsx("p", { style: styles.content, children: message.content }), jsx("p", { style: styles.timestamp, children: message.timestamp.toLocaleTimeString('en-US', {
                                hour: '2-digit',
                                minute: '2-digit'
                            }) })] })) })] }));
}
...
export { ChatInterface, MessageBubble, defaultConfig, version };
