...
export default function ChatInterface({ onSendMessage, initialMessages, placeholder = "Type your message...", title = "PuppyChat", className = "", disabled = false, width = '80vw', height = '800px', welcomeMessage = "Hello! I am PuppyChat AI assistant. How can I help you?", showAvatar = true, recommendedQuestions = [
    ...
    const shouldShowRecommendedQuestions = showRecommendedQuestions &&
        ...
        !isTyping;
    return (_jsxs("div", { style: styles.container, className: className, "aria-hidden": "true", "data-nosnippet": true, "data-variant": variant, children: [showHeader && (_jsxs("div", { style: styles.header, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '12px', height: '26px' }, children: [_jsx("div", { style: {
                                    width: '26px',
                                    height: '26px',
                                    borderRadius: '50%',
                                    display: 'flex',
                                ...
                                }, children: _jsx(Bot, { style: { width: '20px', height: '20px', color: '#8b8b8b' } }) }), _jsx("div", { children: _jsx("div", { style: { fontSize: '14px', fontWeight: 'normal', color: '#8b8b8b', margin: 0, height: '26px', lineHeight: '26px' }, children: title }) })] }), _jsx("button", { onClick: clearChat, style: {
                            width: '26px',
                            height: '26px',
                            padding: '0',
                            borderRadius: '8px',
