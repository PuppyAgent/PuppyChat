...
import { Bot, User, Trash2, X, MessageCircle } from 'lucide-react';
...
function ChatInterface({ onSendMessage, initialMessages, placeholder = "Type your message...", title = "PuppyChat", className = "", disabled = false, width = '80vw', height = '800px', welcomeMessage = "Hello! I am PuppyChat AI assistant. How can I help you?" } = {}) {
    ...
    return (jsxs("div", { style: styles.container, className: className, children: [jsxs("div", { style: styles.header, children: [jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' }, children: [jsx("div", { style: {
                        ...
                        }, title: "Clear chat history", children: jsx(Trash2, { style: { width: '16px', height: '16px' } }) })] }), jsxs("div", { style: styles.messagesContainer, children: [messages.map((message) => (jsx(MessageBubble, { message: message }, message.id))), isTyping && (jsx(MessageBubble, { message: {
                            id: 'typing',
                            content: '',
                            sender: 'bot',
                            timestamp: new Date()
...
function FloatingBubble({ onClick, isOpen = false, className = "", size = 60, position = 'bottom-right', pulseAnimation = true }) {
    ...
    return (jsx("div", { style: styles.container, className: className, onClick: onClick, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false), role: "button", "aria-label": isOpen ? "Close chat" : "Open chat", tabIndex: 0, onKeyDown: (e) => {
        ...
        }, children: isOpen ? (jsx(X, { style: styles.icon })) : (jsx(MessageCircle, { style: styles.icon })) }));
}
...
export { ChatBubble, ChatInterface, FloatingBubble, MessageBubble, defaultConfig, version };
