...
function ChatInterface({ onSendMessage, initialMessages, placeholder = "Type your message...", title = "PuppyChat", className = "", disabled = false, width = '80vw', height = '800px', welcomeMessage = "Hello! I am PuppyChat AI assistant. How can I help you?", showAvatar = true, recommendedQuestions = [
    ...
    const shouldShowRecommendedQuestions = showRecommendedQuestions &&
        ...
        !isTyping;
    return (jsxRuntime.jsxs("div", { style: styles.container, className: className, children: [showHeader && (jsxRuntime.jsxs("div", { style: styles.header, children: [jsxRuntime.jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' }, children: [jsxRuntime.jsx("div", { style: {
                                    width: '36px',
                                    height: '36px',
                                    borderRadius: '50%',
                                    display: 'flex',
                        ...
                        }, title: "Clear chat history", children: jsxRuntime.jsx(lucideReact.Trash2, { style: { width: '16px', height: '16px' } }) })] })), jsxRuntime.jsxs("div", { style: styles.messagesContainer, children: [messages.map((message) => (jsxRuntime.jsx(MessageBubble, { message: message, showAvatar: showAvatar }, message.id))), shouldShowRecommendedQuestions && (jsxRuntime.jsx("div", { style: {
                            display: 'flex',
                            flexDirection: 'column',
                            gap: '12px',
                            marginTop: '20px',
...
function ChatInterfaceDeployed(_a) {
    ...
    return (jsxRuntime.jsx(ChatInterface, Object.assign({}, chatInterfaceProps, { onSendMessage: handleSendMessage })));
}
...
function FloatingBubble({ onClick, isOpen = false, className = "", size = 60, position = 'bottom-right', pulseAnimation = true }) {
    ...
    return (jsxRuntime.jsx("div", { style: styles.container, className: className, onClick: onClick, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false), role: "button", "aria-label": isOpen ? "Close chat" : "Open chat", tabIndex: 0, onKeyDown: (e) => {
        ...
        }, children: isOpen ? (jsxRuntime.jsx(lucideReact.ChevronDown, { style: styles.icon })) : (jsxRuntime.jsx(ChatBubbleIcon, { size: size * 0.5 })) }));
}
